import { generatebrazildata, generateenglanddata, generategermanydata, } from "../services/footballservices.js";
/**
 * Gets the weather data for a city
 * @param req the request object
 * @param res the response object
 */
export const getfootballdata = async (req, res) => {
